...
const sponsors: Vertical = {
  ...
  seo: {
    ...
    // buyer actually searches — syndicator and 506(c) sponsor.
    title: "Investor Acquisition for Real Estate Syndicators & 506(c) Sponsors",
    description:
...
export const sponsorsPage: SponsorPageContent = {
  ...
  glance: {
    ...
    facts: [
      ...
      { label: "Founder", value: "Caleb Free, Founder and Managing Member" },
    ],
  },
