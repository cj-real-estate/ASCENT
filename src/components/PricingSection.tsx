          ...
          {pricing.cards.map((card) => {
            ...
            return (
              <li
                ...
                className={
                  dark
                    ? "rounded-xl border border-ink bg-ink p-6 motion-safe:transition-transform motion-safe:hover:-translate-y-1"
                    : "rounded-xl border border-line bg-paper p-6 motion-safe:transition-[transform,border-color] motion-safe:hover:-translate-y-1 hover:border-slate"
                }
              >
                <h3
