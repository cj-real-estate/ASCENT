      ...
      <main className="py-16 md:py-24">
        <div className={shell}>
          ...
          <p className={pClass}>
            ...
            one for non-marketing messages about the scoping call you booked, one for marketing
            messages. They are separate permissions, and the program both opt into is described
            here in full. These are messages to you, the sponsor, about your own enquiry — they are unrelated to how Ascent contacts a sponsor&apos;s investor
